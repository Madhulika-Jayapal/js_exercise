...
point3 = move(point1, { x: -1, y: 3 });
console.log("\nMove -1 across and 3 up");
showPoint(point3);
...
point4 = reflectX(point1);
console.log("\nReflect across x-axis");
showPoint(point4);

// Further Adventure 3: Rotate point by 90 degrees anticlockwise
